...
class example1 extends Febric {
	...
	public function init() {
		return render('example1.html', $this->getVendors());
	}
	...
	private function getVendors() {
		return array('vendors' => queryArray('SELECT point_id AS vendor_id, point_name AS vendor_name, point_dict AS vendor_dict FROM point
	...
	public function getProducts() {
		...
		return array('products' => queryArray("SELECT product_id, product_name, product_dict, amount FROM product
