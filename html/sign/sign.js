...
window.addEventListener('load', function () {
  ...
  function init () {
    ...
    // Attach the mousedown, mousemove, mouseup, touchstart, touchmove and 
	...
	*/
    ...
    save.addEventListener('click', function (ev) {
      var img = canvaso.toDataURL();
      act('addSign', {img: img}, function() {
...
//    console.log(ev.type);
  ...
  tools.pencil = function () {
    ...
    this.touchend = this.mouseup = function (ev) {
      ...
      if (tool.started) {
        if (!tool.moved) {
          ev._x = tool.touch_x + 3;
          ev._y = tool.touch_y + 3;
          tool.mousemove(ev);
        }
        tool.started = false;
        img_update();
